    ...
    <main className="min-h-screen bg-zinc-950">
      <div className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          ...
          <h1 className="mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">Privacy Policy</h1>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            ...
            <Link href="/legal/dpa" className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-white/80 hover:bg-white/10 hover:text-white transition">
