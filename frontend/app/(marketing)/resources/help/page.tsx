...
import { HelpCentre, type HelpCategory } from "@/components/marketing/receptionist/HelpCentre";
...
// below is byte-for-byte identical to the fact-checked content from the
// 2026-08-17 audit (see the git history on this file for that audit's own
// comment, cross-checking every claim against real code). This pass only
// changes how it's organized and rendered — search, a category accordion,
// anchors, and real per-question "was this helpful?" voting
// (components/marketing/receptionist/HelpCentre.tsx) — never the words.
// Slugs are hardcoded (not derived from question text) so they stay stable
// even if this file's formatting changes, since they're also the vote
// key sent to /api/help/feedback.
