  ...
  return (
    <div className="bg-[#f8fafc] pt-16">
      <section className="mx-auto max-w-2xl px-6 py-16 text-center">
        <h1 className="text-3xl font-bold text-[#0f172a] sm:text-4xl">Talk to Charlotte right now</h1>
        <p className="mt-3 text-[#475569]">This is a real AI — Charlotte will answer instantly, no waiting, no script reading on our end.</p>
