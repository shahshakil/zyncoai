...
import { FAQS } from "@/components/seo/HomepageFaqJsonLd";

// Renders the exact same Q&A content the FAQPage JSON-LD in
// HomepageFaqJsonLd describes — Google's structured data guidelines
// require FAQ schema to reflect visible page content, not markup nobody
// can actually read.
  ...
  return (
    <section className="py-20">
      <div className="mx-auto max-w-2xl text-center">
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#94a3b8]">FAQ</p>
        <h2 className="mt-2 text-3xl font-bold text-[#0f172a] sm:text-4xl">Common questions</h2>
      </div>
