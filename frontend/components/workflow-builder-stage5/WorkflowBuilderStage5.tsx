...
import NodePalette from "@/components/workflow-builder-stage5/panels/NodePalette";
import InspectorPanel from "@/components/workflow-builder-stage5/panels/InspectorPanel";
...
import { makeNode, toWorkflowSpec } from "@/lib/workflow-builder-stage5/nodeFactory";
import {
  createWorkflowDraft,
  deployWorkflowDraft,
  runWorkflowTest,
...
import type { BuilderNodeKind } from "@/lib/workflow-builder-stage5/types";

export default function WorkflowBuilderStage5() {
  ...
  return (
    <main className="mx-auto max-w-[1600px] px-6 py-10">
      <div className="mb-8">
        <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">WorkflowOps Stage 5</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight text-neutral-950">
          Connector-Native Workflow Builder
        </h1>
        <p className="mt-4 max-w-4xl text-base leading-7 text-neutral-600">
          Build connector-native automation flows with run controls, retries, cancellation, and execution visibility.
        </p>
      </div>
